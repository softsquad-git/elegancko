...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    loadData: function loadData() {
      ...
      this.$Progress.start();
      this.$axios.get("admin/users/all?page=".concat(page, "&name=").concat(this.params.name, "&email=").concat(this.params.email, "&is_activated=").concat(this.params.is_activated, "&ordering=").concat(this.params.ordering, "&pagination=").concat(this.params.pagination)).then(function (data) {
