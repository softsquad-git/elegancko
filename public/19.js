...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    loadData: function loadData() {
      ...
      this.$Progress.start();
      this.$axios.get("admin/pages/all?page=".concat(page, "&title=").concat(this.params.title, "&is_active=").concat(this.params.is_active, "&position=").concat(this.params.position, "&ordering=").concat(this.params.ordering, "&pagination=").concat(this.params.pagination)).then(function (data) {
              ...
              _c(
                ...
                _vm._l(_vm.data.data, function(page, index) {
                  return _c("tr", { key: page.id }, [
                    ...
                    _vm._v(" "),
                    _c("td", { domProps: { innerHTML: _vm._s(page.locale) } }),
                    _vm._v(" "),
                    _c(
                      "td",
                      [
