...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    loadData: function loadData() {
      ...
      this.$axios.get("admin/orders/all?email=".concat(this.params.email, "&status=").concat(this.params.status, "&payment_status=").concat(this.params.payment_status, "&ordering=").concat(this.params.ordering, "&pagination=").concat(this.params.pagination)).then(function (data) {
