...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    loadData: function loadData() {
      ...
      this.$axios.get("front/products/all?title=".concat(this.params.title, "&category_id=").concat(this.params.category_id, "&ordering=").concat(this.params.ordering, "&pagination=").concat(this.params.pagination, "&type=").concat(this.params.type)).then(function (data) {
