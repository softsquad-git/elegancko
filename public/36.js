...
var render = function() {
  ...
  return _c(
    ...
    [
        ...
        [
          ...
          _c("div", { staticClass: "form-group" }, [
            _c("input", {
              ...
              attrs: {
                id: "password",
                "aria-label": _vm.$t("form.pass"),
                type: "password",
                placeholder: _vm.$t("form.pass")
              },
            ...
            [
              ...
              _c(
                "router-link",
                {
                  ...
                  attrs: {
                    to: { name: "Register" },
                    title: _vm.$t("nav.auth.register")
                  }
                },
                [_vm._v(_vm._s(_vm.$t("nav.auth.register")) + "\n            ")]
              )
            ],
            1
          )
      ...
      _vm._v(" "),
      _c("meta-component", { attrs: { type: "LOGIN" } })
    ],
    1
  )
}
