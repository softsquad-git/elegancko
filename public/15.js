...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    loadData: function loadData() {
      ...
      this.$axios.get("admin/products/all?title=".concat(this.params.title, "&category=").concat(this.params.category, "&is_activated=").concat(this.params.is_activated, "&ordering=").concat(this.params.ordering, "&pagination=").concat(this.params.pagination, "&type=").concat(this.params.type, "&locale=").concat(this.params.locale)).then(function (data) {
