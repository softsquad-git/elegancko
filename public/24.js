  ...
  methods: {
    ...
    getRelatedProducts: function getRelatedProducts() {
      ...
      this.$axios.get("front/products/all?category_id=".concat(1, "&pagination=4")).then(function (data) {
        _this2.isLoadingRelatedProduct = false;
    ...
    [
      _c("div", { staticClass: "row mb-2" }, [
        _c(
          ...
          [
            _c("viewer", { attrs: { images: _vm.product.images } }, [
              _c(
                "div",
                { staticClass: "row" },
                _vm._l(_vm.product.images, function(image) {
                  return _c(
                    "div",
                    { key: image.src, staticClass: "col-4 p-1" },
                    [
                      _c("img", {
                        staticClass: "w-100 product-show-image img-thumbnail",
                        attrs: { alt: image.src, src: image.src }
                      })
                    ]
                  )
                }),
            ...
            _c(
              ...
              [
                _c("span", { staticClass: "text-bold" }, [
                  _vm._v(_vm._s(_vm.$t("page.product.category")) + ": ")
                ]),
                _c(
                  "router-link",
                  {
              ...
              [
                ...
                _c("multiselect", {
                  ...
                  attrs: {
                    ...
                    multiple: false,
                    placeholder: _vm.$t("page.product.select_size"),
                    "track-by": "id"
                  },
                  model: {
                    value: _vm.data.size,
                ...
                _c("multiselect", {
                  ...
                  attrs: {
                    ...
                    "close-on-select": true,
                    multiple: false,
                    placeholder: _vm.$t("page.product.select_color"),
                    "track-by": "id"
                  },
                  model: {
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    [_vm._v(_vm._s(_vm.$t("page.product.add_basket")))]
                  )
                ],
                1
              ),
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    [_vm._v(_vm._s(_vm.$t("page.product.buy_now")))]
                  )
                ],
                1
              )
            ...
            [
              _c("div", { staticClass: "col-12" }, [
                _c(
                  ...
                  [
                    _vm._v(
                      _vm._s(_vm.$t("page.product.in_some_category")) + " "
                    ),
                    _vm.isLoadingRelatedProduct
                      ? _c("b-spinner", {
                          staticClass: "float-right",
                          attrs: {
                            small: "",
                            label: _vm.$t(
                              "page.product.loading_related_product"
                            )
                          }
                        })
                      : _vm._e()
